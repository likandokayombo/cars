...
export default function CarImageUpload({
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {!preview ? (
        <div className="border-2 border-dashed border-gray-300 rounded-xl p-4 sm:p-8 flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 transition-all duration-300 text-center">
          {/* Upload Icon */}
        ...
        <div className="relative w-full overflow-hidden rounded-xl shadow-lg group z-10">
          <div className="w-full aspect-video relative">
            ...
            />
            <button
              className="bg-white text-black hover:bg-gray-200 absolute right-1 z-10 top-1 sm:hidden"
              onClick={() => {
                setPreview(null);
                setImageUrl("");
              }}
